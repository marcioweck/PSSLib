...
if __name__=='__main__':
    ...
    parms = (0., 1.), (0., 1.)
    c = lhs(dist, parms, siz=7)
    cmax = -6
    cmin = 6
    c = numpy.array(c)
    c = (cmax - cmin)*c + cmin
    d = lhsFromSample(c, (2,4))
    d2 = lhsFromSample(c, (2,4))
...
#     #print numpy.array(c).T
    P.scatter(c[0],c[1])
    # P.scatter(n[0],n[1], c='g')
    P.scatter(d[0],d[1], c='r')
    P.scatter(d2[0],d2[1], c='r')
